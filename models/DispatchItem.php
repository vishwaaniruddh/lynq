...
/**
 * DispatchItem Model
 * Represents a line item in a dispatch
 * 
...
class DispatchItem extends BaseModel {
    ...
    protected $fillable = [
        'dispatch_id', 'product_id', 'asset_id', 'quantity'
    ];
    ...
    public function findAllByDispatchWithDetails($dispatchId) {
        ...
        return DatabaseConfig::getInstance()->getResults($sql, [$dispatchId], 'i');
    }
    ...
    public function getTotalQuantityForProduct($dispatchId, $productId) {
        ...
        $result = DatabaseConfig::getInstance()->getResults($sql, [$dispatchId, $productId], 'ii');
    ...
    public function countByDispatch($dispatchId) {
        ...
        $result = DatabaseConfig::getInstance()->getResults($sql, [$dispatchId], 'i');
    ...
    public function deleteByDispatch($dispatchId) {
        ...
        $stmt = DatabaseConfig::getInstance()->executeQuery($sql, [$dispatchId], 'i');
