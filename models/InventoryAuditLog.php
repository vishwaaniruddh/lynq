<?php
/**
 * InventoryAuditLog Model
 * Represents audit trail entries for inventory actions
 * 
 * Requirements: 12.1
...
class InventoryAuditLog extends BaseModel {
    protected $table = 'inventory_audit_log';
    protected $fillable = [
        'action_type', 'entity_type', 'entity_id',
        'user_id', 'from_location_type', 'from_location_id',
    ...
    public function findByEntity($entityType, $entityId) {
        ...
        return DatabaseConfig::getInstance()->getResults($sql, [$entityType, $entityId], 'si');
    }
    ...
    public function findByActionType($actionType) {
        return $this->findAll(['action_type' => $actionType], 'created_at DESC');
    }
