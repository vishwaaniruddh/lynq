    ...
    <div class="bg-white rounded-xl shadow-sm">
        ...
        <div class="p-6 border-b flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">Update site information</p>
            </div>
        ...
        <form id="site-form" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="lho" name="lho" required
                            value="<?php echo htmlspecialchars($site['lho']); ?>"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="bank_name" name="bank_name"
                            value="<?php echo htmlspecialchars($site['bank_name'] ?? ''); ?>"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                    </div>
                    <div>
                        <label for="customer_name" class="block text-sm font-medium text-gray-700 mb-1">Customer Name</label>
                        <input type="text" id="customer_name" name="customer_name"
                            value="<?php echo htmlspecialchars($site['customer_name'] ?? ''); ?>"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                    </div>
                </div>
            </div>
            ...
            <div class="border-b pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" id="city" name="city" required
                            value="<?php echo htmlspecialchars($site['city']); ?>"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                    ...
                    <div>
                        ...
                        <input type="text" id="state" name="state" required
                            value="<?php echo htmlspecialchars($site['state']); ?>"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                    ...
                    <div>
                        ...
                        <input type="text" id="country" name="country" required
                            value="<?php echo htmlspecialchars($site['country']); ?>"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="zone" name="zone"
                            value="<?php echo htmlspecialchars($site['zone'] ?? ''); ?>"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                    </div>
                    <div>
                ...
                <div class="mt-4">
                    ...
                    <textarea id="address" name="address" rows="3"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"><?php echo htmlspecialchars($site['address'] ?? ''); ?></textarea>
                </div>
            </div>
            ...
            <div class="pb-6">
                ...
                <div id="map-container" class="h-64 bg-gray-100 rounded-lg flex items-center justify-center border">
                    <div id="map-placeholder" class="text-center text-gray-500 <?php echo ($site['latitude'] && $site['longitude']) ? 'hidden' : ''; ?>">
                    ...
                    <div id="map-preview" class="<?php echo ($site['latitude'] && $site['longitude']) ? '' : 'hidden'; ?> w-full h-full"></div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-4 text-sm text-gray-600">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <span class="ml-1"><?php echo date('M d, Y H:i', strtotime($site['created_at'])); ?></span>
                    </div>
                    <div>
                        <span class="text-gray-400">Created By:</span>
                        <span class="ml-1">User #<?php echo $site['created_by']; ?></span>
                    </div>
                    <?php if ($site['updated_at']): ?>
                    <div>
                        <span class="text-gray-400">Updated:</span>
                        <span class="ml-1"><?php echo date('M d, Y H:i', strtotime($site['updated_at'])); ?></span>
                    </div>
                    <?php endif; ?>
                    <?php if ($site['updated_by']): ?>
                    <div>
                        <span class="text-gray-400">Updated By:</span>
                        <span class="ml-1">User #<?php echo $site['updated_by']; ?></span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
